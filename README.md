...
- El ícono de la app (`favicon-32.png`, `icon-192.png`, `icon-512.png`, `icon-512-maskable.png`, `apple-touch-icon.png`) y la ilustración grande de la bienvenida (`welcome-icon.png`) salen de la misma pieza de arte, recortada, aplanada sobre fondo crema `#F8F5EF` y exportada en cada tamaño. Si más adelante querés reemplazarla por otra imagen, alcanza con generar de nuevo esos mismos cinco archivos manteniendo los nombres.
